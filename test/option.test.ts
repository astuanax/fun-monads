...
describe('Option', function () {
  ...
  test('Applicative laws: interchange', () => {
    ...
    const expected = monad.ap(monad((f:any) => f(x)), u)
  ...
  test.each(fixturesNone)(
    'Monad law: left identity with None',
    (a) => {
      let x:any = undefined
